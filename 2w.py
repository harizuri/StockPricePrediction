...
class base_pattern:
    ...
    def train_main(self):
        ...
        print("****** start ******")
        print("****** 学習データ　サンプリング ******")
        features, target, dates = self.make_data("8306.T")
        print("****** 学習 ******")
    ...
    def make_data(self,target):
        stock = DATA.StockData(target,self.period)
        # 正解データ
    ...
    def com_data(self):
        stock = DATA.ComData(self.period)
        # 為替データ取得
        df_fx = stock.get_jpy()
